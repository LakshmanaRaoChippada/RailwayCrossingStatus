<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="dao.DBConnection,java.sql.Connection,java.sql.PreparedStatement,java.sql.ResultSet"%>
    ...
    <body onload="myFunction()">
        ...
        <nav class="menu">
            <div>
                ...
                <a href="adminfavourite.jsp"><input type="submit" value="Favourate Crossing" class="btn btn-secondary"></a>
                <input type="text" placeholder="Search..." class="search"/>
                <input type="submit" value="Go">
                <a href="manageadmin.jsp"><input type="submit" class="btn btn-secondary" value="Manage"></a>
            </div>
        </nav>
		...
		<% while(rs.next()){ %>
			<div class="card">
	  		<div class="card-body">
	    		...
	    		<p class="card-text">Crossing Status : <span id="status" class="btn btn-success"> <%= rs.getString(6)%> </span></p>
				...
				<form action="AdminFavourite">
					<input type="text" value=<%= rs.getString("crossingname") %> name="adminfavourite" hidden=hidden/>
