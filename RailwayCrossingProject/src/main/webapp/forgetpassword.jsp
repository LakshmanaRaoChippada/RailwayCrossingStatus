    ...
    <body>
        <form method="post" action="ForgetPassword">
            <div class="container">
                ...
                <input style="margin-top: 5px; height: 9%; width: 100%; border-radius: 8%;" type="email" name="gmail" placeholder="Enter E-Mail Address" required><br>
                <label style="margin-top: 20px;">New Password : </label><br>
                <input style="margin-top: 5px; height: 9%; width: 100%; border-radius: 8%;" type="password" name="password" placeholder="Enter Password" required><br><br><br>
                <input type="submit" value="Submit" style="width: 45%; margin-left: 5px;" class="btn btn-primary">
