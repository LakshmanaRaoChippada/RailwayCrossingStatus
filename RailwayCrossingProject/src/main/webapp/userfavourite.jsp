	...
	<body onload="myFunction()">
        ...
        <nav class="menu">
            <div>
                ...
                <a href="userfavourite.jsp"><input type="submit" value="Your Favourate Crossing" class="btn btn-secondary"></a>
            </div>
        </nav>
        <% Connection con = DBConnection.getCon(); %>
		<% PreparedStatement ps = con.prepareStatement("select * from favourite"); %>
